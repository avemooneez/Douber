    ...
    def edit_selectedCryptos(self, user_id: int, selCrpt: str, OnOff: bool):
        with self.conn:
            ...
            if selCrpt == "TON" and OnOff == True:
                ...
                return self.cur.execute("UPDATE `settingss` SET `TONUSDT` = ? WHERE `user_id` = ?", ('0', user_id,))
            ...
            if selCrpt == "SOL" and OnOff == True:
                ...
                return self.cur.execute("UPDATE `settingss` SET `SOLUSDT` = ? WHERE `user_id` = ?", ('0', user_id,))
